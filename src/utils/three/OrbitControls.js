...
const OrbitControls = function (camera, object, domElement) {
  ...
  this.update = (function () {
    ...
    return function update () {
      ...
      //   console.debug('update', position, offset)
      ...
      scope.object.lookAt(scope.target) // ? not sure(camera or object)
      //   scope.camera.lookAt(scope.target) // ? not sure(camera or object)
